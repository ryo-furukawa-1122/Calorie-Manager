    ...
    return (
        <div className='flex flex-col relative'>
            <div className='flex flex-col p-2 bg-slate-50 dark:bg-slate-700 w-5/6 mx-auto my-5 rounded shadow-md'>
                <Select id='purpose' className='dark:text-slate-700 m-2 ja' options={purpose} onChange={handlePurAmp} placeholder='目的' />
                <Select id='purpose' className='dark:text-slate-700 m-2 en hide' options={purposeEn} onChange={handlePurAmp} placeholder='Aim' />
                ...
                <Select className='dark:text-slate-700 m-2 ja' options={activity} onChange={handleActAmp} placeholder='活動量' />
                <Select className='dark:text-slate-700 m-2 en hide' options={activityEn} onChange={handleActAmp} placeholder='Activity' />
                <label className='m-2 ja'>
                    食事数：
            ...
            <div className='p-2 bg-slate-50 dark:bg-slate-700 w-5/6 mx-auto my-5 rounded shadow-md ja'>
                1日の摂取量：<span className='mx-3'>{intake}</span>kcal
            </div>
            <div className='p-2 bg-slate-50 dark:bg-slate-700 w-5/6 mx-auto my-5 rounded shadow-md en hide'>
